...
//  Tests macOS
//
//  Created by jon on 6/3/22.
//

import XCTest
// @testable import kuluu
// @testable import Networking

class BlowfishSpec: XCTestCase {
    ...
    func testBlowfish() throws {
        try defaultBlowfish.decrypt([])
//        defaultBlowfish.decrypt()
    }
...
public let defaultBlowfish: Blowfish = {
    ...
    return try! .init(key: keyHash, padding: .pkcs7)
...
public final class Blowfish {
    ...
    private func TT(x: UInt32) -> UInt32 {
        // swift-compiler-needs-this-to-be-split-up-translation-of:
